                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="position">
                                ...
                                <option value="0"{{ $offer->position == 0 ? ' selected' : '' }}>Full-time</option>
                                <option value="0"{{ $offer->position == 1 ? ' selected' : '' }}>Part-time</option>
                                <option value="0"{{ $offer->position == 2 ? ' selected' : '' }}>Turnos</option>
                            </select>
