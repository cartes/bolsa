        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 783px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a href="{{ route('prices') }}">
                        <img src="{{asset('/images/popup.png')}}" alt="Oferta Portal de Empleos"/>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center mb-4">
            ...
            <div id="search-container" class="col-md-8">
                <div class="row row-form position-relative">
                ...
                <div class="container d-none d-md-block">
                    <div class="row p-md-5 row-eq-height">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="text-justify">
                                Somos parte del Grupo Editorial Editec, así que muchos ya nos conocen. Llevamos más de
                                diez
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="text-justify">
                                www.empleosaqua.cl es una iniciativa del Grupo Editorial Editec, casa editorial de
                                revista
                                AQUA y el portal www.aqua.cl, y organizadora de la feria internacional AquaSur. Nos
                                hemos
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    @if ($offer->businessMeta)
                                        ...
                                        <h3 class="text-white mb-0">{{ $offer->businessMeta->fantasy_name }}</h3>
