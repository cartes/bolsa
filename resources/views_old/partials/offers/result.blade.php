    ...
    @if ($offers->total() > 0)
        <div id="container-offer-display" class="col-md-7 pl-0 border d-none d-md-block">
            <div class="row p-3 px-5">
                <div class="col-12">
                    <small id="container-offer-title-created-at">{{ $offers[0]->created_at->format("d \\d\\e F \\d\\e Y") }}</small>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <p id="container-business-comune" class="m-0 p-0 mb-5">{{ $offers[0]->businessMeta->comune }}</p>
                </div>
                @endif
